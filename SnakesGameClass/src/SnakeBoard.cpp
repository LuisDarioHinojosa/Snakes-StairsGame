...
SnakeBoard::SnakeBoard(int size, int row, int codeNum,int stairs ,vector<int>* dec,vector<string>*enc,vector <int>* snakes, vector <int>* ladders)
:GameBoard(size,row,codeNum,dec,enc),numSL(stairs),snakes(*snakes),ladders(*ladders)
{
